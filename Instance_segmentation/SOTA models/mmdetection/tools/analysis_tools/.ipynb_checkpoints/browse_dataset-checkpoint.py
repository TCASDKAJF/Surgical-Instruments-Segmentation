...
def parse_args():
    ...
    parser.add_argument('--config', default='work_dirs/mask_rcnn_swin-t-p4-w7_fpn_1x_coco/mask_rcnn_swin-t-p4-w7_fpn_1x_coco.py',help='train config file path')
    parser.add_argument(
        '--skip-type',
        type=str,
        nargs='+',
        default=['DefaultFormatBundle', 'Normalize', 'Collect','RandomFlip','Resize'],
        help='skip some useless pipeline')
    parser.add_argument(
        '--output-dir',
        default='data_vis/val',
        type=str,
