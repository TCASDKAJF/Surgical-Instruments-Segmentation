...
def deal_json(ds_type, img_path, json_path):
    ...
    for img_file in os.listdir(img_path):
        ...
        if img_file.split('.')[
                -1] not in ['bmp', 'jpg', 'jpeg', 'png', 'JPEG','tif', 'JPG', 'PNG']:
            continue
...
def main():
    ...
    parser.add_argument('--json_input_dir',default='seg_json', help='input annotated directory')
    parser.add_argument('--image_input_dir',default='jpeg_1', help='image directory')
    parser.add_argument(
        '--output_dir', help='output dataset directory', default='./coco_seg')
    parser.add_argument(
        '--train_proportion',
